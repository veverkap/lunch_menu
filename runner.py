...
url = f"https://webapis.schoolcafe.com/api/CalendarView/GetDailyMenuitems?SchoolId={school_id}&ServingDate={urllib.parse.quote(serving_date)}&ServingLine=Standard%20Line&MealType=Lunch"
print(url)
r = requests.get(url)
data = r.json()
print(data)
